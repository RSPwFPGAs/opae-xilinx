...
proc create_root_design { parentCell } {
  ...
  set adders_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:adders adders_0 ]

  # Create instance: axi_interconnect_0, and set properties
  set axi_interconnect_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect axi_interconnect_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net AFU_base_ip_IP_M_AXI_LITE_CTRL [get_bd_intf_pins AFU_base_ip/IP_M_AXI_LITE_CTRL] [get_bd_intf_pins axi_interconnect_0/S00_AXI]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins adders_0/s_axi_AXILiteS] [get_bd_intf_pins axi_interconnect_0/M00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins AFU_base_ip/IP_S_AXI_FULL_DATA] [get_bd_intf_pins axi_interconnect_0/M01_AXI]
  ...
  connect_bd_net -net AFU_base_ip_ip_axi_aclk_ctrl [get_bd_pins AFU_base_ip/ip_axi_aclk_ctrl] [get_bd_pins adders_0/ap_clk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK]
  connect_bd_net -net AFU_base_ip_ip_axi_aclk_data [get_bd_pins AFU_base_ip/ip_axi_aclk_data] [get_bd_pins axi_interconnect_0/M01_ACLK]
  connect_bd_net -net AFU_base_ip_ip_axi_aresetn_ctrl [get_bd_pins AFU_base_ip/ip_axi_aresetn_ctrl] [get_bd_pins adders_0/ap_rst_n] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN]
  connect_bd_net -net AFU_base_ip_ip_axi_aresetn_data [get_bd_pins AFU_base_ip/ip_axi_aresetn_data] [get_bd_pins axi_interconnect_0/M01_ARESETN]
  connect_bd_net -net I_ROLE_RSTN_1 [get_bd_ports I_RSTN_PORT] [get_bd_pins AFU_base_ip/I_RSTN_PORT]
  connect_bd_net -net adders_0_interrupt [get_bd_pins AFU_base_ip/IP_S_USR_IRQ] [get_bd_pins adders_0/interrupt]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A10000 [get_bd_addr_spaces S_AXI_LITE_CTRL_PORT] [get_bd_addr_segs adders_0/s_axi_AXILiteS/Reg] SEG_adders_0_Reg
