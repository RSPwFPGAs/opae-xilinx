...
resize_pblock [get_pblocks pblock_role_0] -add {CLOCKREGION_X0Y0:CLOCKREGION_X4Y3}
resize_pblock [get_pblocks pblock_role_0] -add {CLOCKREGION_X0Y4:CLOCKREGION_X7Y7}
