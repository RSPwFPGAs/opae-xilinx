...
proc create_hier_cell_debug_bridge { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_debug_bridge() - Empty argument(s)!"}
     return
  }
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S_BSCAN_PORT_1 [get_bd_intf_pins S_BSCAN_PORT] [get_bd_intf_pins debug_bridge_0/S_BSCAN]
...
proc create_hier_cell_axilite_buffer { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net axi_interconnect_2_M00_AXI [get_bd_intf_pins M_AXI_LITE_CTRL_PORT] [get_bd_intf_pins axi_interconnect_1/M00_AXI]
  ...
  # Create port connections
  connect_bd_net -net axi_aclk_role_ctrl_1 [get_bd_pins axi_aclk_ctrl_port] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_interconnect_1/S01_ACLK] [get_bd_pins jtag_axi_0/aclk] [get_bd_pins system_ila_0/clk]
  connect_bd_net -net axi_aresetn_role_ctrl_1 [get_bd_pins axi_aresetn_ctrl_port] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_interconnect_1/S01_ARESETN] [get_bd_pins jtag_axi_0/aresetn] [get_bd_pins system_ila_0/resetn]

  # Restore current instance
  current_bd_instance $oldCurInst
}

# Hierarchical cell: axifull_buffer
proc create_hier_cell_axifull_buffer { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_axifull_buffer() - Empty argument(s)!"}
     return
  }
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net AFU_core_M_AXI_FULL_DATA_PORT [get_bd_intf_pins S00_AXI] [get_bd_intf_pins axi_interconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net [get_bd_intf_nets AFU_core_M_AXI_FULL_DATA_PORT] [get_bd_intf_pins S00_AXI] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins M_AXI_FULL_DATA_PORT] [get_bd_intf_pins axi_interconnect_0/M00_AXI]
  ...
  # Create port connections
  connect_bd_net -net axi_aclk_role_data_1 [get_bd_pins axi_aclk_data_port] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins jtag_axi_0/aclk] [get_bd_pins system_ila_0/clk]
  connect_bd_net -net reset_buffer_ctrl1_Q [get_bd_pins ARESETN] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins jtag_axi_0/aresetn] [get_bd_pins system_ila_0/resetn]
...
proc create_hier_cell_AFU_core { parentCell nameHier } {
  ...
  connect_bd_net -net axi_aclk_data_port_1 [get_bd_pins axi_aclk_data_port] [get_bd_pins axi_cdma_0/m_axi_aclk]
...
proc create_hier_cell_AFU { parentCell nameHier } {
  ...
  # Create instance: axifull_buffer
  create_hier_cell_axifull_buffer $hier_obj axifull_buffer

  # Create instance: axilite_buffer
  create_hier_cell_axilite_buffer $hier_obj axilite_buffer

  # Create instance: debug_bridge
  create_hier_cell_debug_bridge $hier_obj debug_bridge

  # Create instance: reset_buffer
  create_hier_cell_reset_buffer $hier_obj reset_buffer

  # Create interface connections
  connect_bd_intf_net -intf_net AFU_core_M_AXI_FULL_DATA_PORT [get_bd_intf_pins AFU_core/M_AXI_FULL_DATA_PORT] [get_bd_intf_pins axifull_buffer/S00_AXI]
  ...
  connect_bd_intf_net -intf_net S_BSCAN_PORT_1 [get_bd_intf_pins S_BSCAN_PORT] [get_bd_intf_pins debug_bridge/S_BSCAN_PORT]
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins M_AXI_FULL_DATA_PORT] [get_bd_intf_pins axifull_buffer/M_AXI_FULL_DATA_PORT]
  ...
  connect_bd_net -net axi_aclk_role_ctrl_1 [get_bd_pins axi_aclk_ctrl_port] [get_bd_pins AFU_core/axi_aclk_ctrl_port] [get_bd_pins axilite_buffer/axi_aclk_ctrl_port] [get_bd_pins debug_bridge/axi_aclk_ctrl_port] [get_bd_pins reset_buffer/axi_aclk_ctrl_port]
  connect_bd_net -net axi_aclk_role_data_1 [get_bd_pins axi_aclk_data_port] [get_bd_pins AFU_core/axi_aclk_data_port] [get_bd_pins axifull_buffer/axi_aclk_data_port] [get_bd_pins reset_buffer/axi_aclk_data_port]
  ...
  connect_bd_net -net reset_buffer_ctrl1_Q [get_bd_pins AFU_core/axi_aresetn_data_port] [get_bd_pins axifull_buffer/ARESETN] [get_bd_pins reset_buffer/axi_aresetn_data_port_buffer]
...
proc create_root_design { parentCell } {
  ...
  create_bd_addr_seg -range 0x000100000000 -offset 0x00000000 [get_bd_addr_spaces AFU/AFU_core/axi_cdma_0/Data] [get_bd_addr_segs M_AXI_FULL_DATA_PORT/Reg] SEG_M_AXI_FULL_DATA_PORT_Reg
  create_bd_addr_seg -range 0x000100000000 -offset 0x00000000 [get_bd_addr_spaces AFU/axifull_buffer/jtag_axi_0/Data] [get_bd_addr_segs M_AXI_FULL_DATA_PORT/Reg] SEG_M_AXI_FULL_DATA_PORT_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x00020000 [get_bd_addr_spaces AFU/axilite_buffer/jtag_axi_0/Data] [get_bd_addr_segs AFU/AFU_core/feature_ram/axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
  create_bd_addr_seg -range 0x00010000 -offset 0x00030000 [get_bd_addr_spaces AFU/axilite_buffer/jtag_axi_0/Data] [get_bd_addr_segs AFU/AFU_core/axi_cdma_0/S_AXI_LITE/Reg] SEG_axi_cdma_0_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x00020000 [get_bd_addr_spaces S_AXI_LITE_CTRL_PORT] [get_bd_addr_segs AFU/AFU_core/feature_ram/axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
  create_bd_addr_seg -range 0x00010000 -offset 0x00030000 [get_bd_addr_spaces S_AXI_LITE_CTRL_PORT] [get_bd_addr_segs AFU/AFU_core/axi_cdma_0/S_AXI_LITE/Reg] SEG_axi_cdma_0_Reg
