...
proc create_hier_cell_feature_ram_1 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_feature_ram_1() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_FIU { parentCell nameHier } {
  ...
  create_hier_cell_feature_ram_1 $hier_obj feature_ram
  ...
  # Create port connections
  connect_bd_net -net qdma_0_axi_aclk [get_bd_pins axi_aclk_port_data] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_vip_0/aclk] [get_bd_pins feature_ram/axi_aclk_role_ctrl] [get_bd_pins jtag_axi_0/aclk] [get_bd_pins pcie_axi_bridge/axi_aclk_port_data]
...
proc create_hier_cell_AFU { parentCell nameHier } {
  ...
  connect_bd_net -net axi_aclk_role_ctrl_1 [get_bd_pins axi_aclk_ctrl_port] [get_bd_pins AFU_core/axi_aclk_ctrl_port] [get_bd_pins axilite_buffer/axi_aclk_ctrl_port]
  connect_bd_net -net axi_aclk_role_data_1 [get_bd_pins axi_aclk_data_port] [get_bd_pins AFU_core/axi_aclk_data_port]
  connect_bd_net -net axi_aresetn_data_port_1 [get_bd_pins axi_aresetn_data_port] [get_bd_pins AFU_core/axi_aresetn_data_port]
  connect_bd_net -net axi_aresetn_role_ctrl_1 [get_bd_pins axi_aresetn_ctrl_port] [get_bd_pins AFU_core/axi_aresetn_ctrl_port] [get_bd_pins axilite_buffer/axi_aresetn_ctrl_port]
...
proc create_root_design { parentCell } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net AFU_M_AXI_FULL_DATA_PORT [get_bd_intf_pins AFU/M_AXI_FULL_DATA_PORT] [get_bd_intf_pins FIM/S_AXI_FULL_DATA_PORT0]
  connect_bd_intf_net -intf_net S_AXI_LITE_CTRL_PORT_1 [get_bd_intf_pins AFU/S_AXI_LITE_CTRL_PORT] [get_bd_intf_pins FIM/M_AXI_LITE_CTRL_PORT0]
  ...
  # Create port connections
  connect_bd_net -net AFU_M_USR_IRQ_PORT [get_bd_pins AFU/M_USR_IRQ_PORT] [get_bd_pins FIM/S_USR_IRQ_PORT0]
  connect_bd_net -net I_RSTN_PORT_1 [get_bd_pins AFU/I_RSTN_PORT] [get_bd_pins FIM/O_RSTN_PORT0]
  connect_bd_net -net axi_aclk_ctrl_port_1 [get_bd_pins AFU/axi_aclk_ctrl_port] [get_bd_pins FIM/axi_aclk_ctrl_port]
  connect_bd_net -net axi_aclk_data_port_1 [get_bd_pins AFU/axi_aclk_data_port] [get_bd_pins FIM/axi_aclk_data_port]
  connect_bd_net -net axi_aresetn_ctrl_port_1 [get_bd_pins AFU/axi_aresetn_ctrl_port] [get_bd_pins FIM/axi_aresetn_ctrl_port]
  connect_bd_net -net axi_aresetn_data_port_1 [get_bd_pins AFU/axi_aresetn_data_port] [get_bd_pins FIM/axi_aresetn_data_port]
