...
proc create_hier_cell_pcie_axi_bridge { parentCell nameHier } {
  ...
  set axi_pcie3_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_pcie3 axi_pcie3_0 ]
  set_property -dict [ list \
   CONFIG.AXIBAR_NUM {1} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S_AXI_1 [get_bd_intf_pins S_AXI] [get_bd_intf_pins axi_pcie3_0/S_AXI]
  connect_bd_intf_net -intf_net axi_pcie3_0_M_AXI [get_bd_intf_pins M_AXI] [get_bd_intf_pins axi_pcie3_0/M_AXI]
  connect_bd_intf_net -intf_net axi_pcie3_0_pcie_7x_mgt [get_bd_intf_pins pci_express] [get_bd_intf_pins axi_pcie3_0/pcie_7x_mgt]
  connect_bd_intf_net -intf_net pcie_refclk_1 [get_bd_intf_pins pcie_refclk] [get_bd_intf_pins util_ds_buf/CLK_IN_D]

  # Create port connections
  connect_bd_net -net axi_pcie3_0_axi_aclk [get_bd_pins axi_aclk_port_data] [get_bd_pins axi_pcie3_0/axi_aclk]
  connect_bd_net -net axi_pcie3_0_axi_aresetn [get_bd_pins axi_aresetn_port_data] [get_bd_pins axi_pcie3_0/axi_aresetn]
  connect_bd_net -net pcie_perstn_1 [get_bd_pins pcie_perstn] [get_bd_pins axi_pcie3_0/sys_rst_n]
...
# Hierarchical cell: eth_phy
proc create_hier_cell_eth_phy { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_eth_phy() - Empty argument(s)!"}
     return
  }
  ...
  # Create interface pins
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 refclk_diff
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:xgmii_rtl:1.0 xgmii_interface_ch0
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:xgmii_rtl:1.0 xgmii_interface_ch1

  # Create pins
  create_bd_pin -dir O -from 7 -to 0 core_status_ch0
  create_bd_pin -dir O -from 7 -to 0 core_status_ch1
  create_bd_pin -dir O -type clk coreclk_out
  create_bd_pin -dir I -type clk mdc_ch0
  create_bd_pin -dir I -type clk mdc_ch1
  create_bd_pin -dir I mdio_in_ch0
  create_bd_pin -dir I mdio_in_ch1
  create_bd_pin -dir O mdio_out_ch0
  create_bd_pin -dir O mdio_out_ch1
  create_bd_pin -dir I rxn_ch0
  create_bd_pin -dir I rxn_ch1
  create_bd_pin -dir I rxp_ch0
  create_bd_pin -dir I rxp_ch1
  create_bd_pin -dir I sys_reset_n
  create_bd_pin -dir O tx_disable_ch0
  create_bd_pin -dir O tx_disable_ch1
  create_bd_pin -dir O txn_ch0
  create_bd_pin -dir O txn_ch1
  create_bd_pin -dir O txp_ch0
  create_bd_pin -dir O txp_ch1

  # Create instance: ten_gig_eth_pcs_pma_ch0, and set properties
  set ten_gig_eth_pcs_pma_ch0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:ten_gig_eth_pcs_pma ten_gig_eth_pcs_pma_ch0 ]
  set_property -dict [ list \
  ...
  set ten_gig_eth_pcs_pma_ch1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:ten_gig_eth_pcs_pma ten_gig_eth_pcs_pma_ch1 ]
  set_property -dict [ list \
  ...
  set xlconstant_1b0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant xlconstant_1b0 ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {0} \
 ] $xlconstant_1b0

  # Create instance: xlconstant_1b1, and set properties
  set xlconstant_1b1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant xlconstant_1b1 ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {1} \
 ] $xlconstant_1b1

  # Create instance: xlconstant_3b101, and set properties
  set xlconstant_3b101 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant xlconstant_3b101 ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {5} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins xgmii_interface_ch0] [get_bd_intf_pins ten_gig_eth_pcs_pma_ch1/xgmii_interface]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins xgmii_interface_ch1] [get_bd_intf_pins ten_gig_eth_pcs_pma_ch0/xgmii_interface]
  connect_bd_intf_net -intf_net refclk_diff_port_1 [get_bd_intf_pins refclk_diff] [get_bd_intf_pins ten_gig_eth_pcs_pma_ch0/refclk_diff_port]
  ...
  # Create port connections
  connect_bd_net -net channel_1_tx_disable [get_bd_pins tx_disable_ch1] [get_bd_pins ten_gig_eth_pcs_pma_ch1/tx_disable]
  connect_bd_net -net channel_1_txn [get_bd_pins txn_ch1] [get_bd_pins ten_gig_eth_pcs_pma_ch1/txn]
  connect_bd_net -net channel_1_txp [get_bd_pins txp_ch1] [get_bd_pins ten_gig_eth_pcs_pma_ch1/txp]
  connect_bd_net -net mac_phy_ch0_areset_clk156_out [get_bd_pins ten_gig_eth_pcs_pma_ch0/areset_datapathclk_out] [get_bd_pins ten_gig_eth_pcs_pma_ch1/areset_coreclk]
  connect_bd_net -net mac_phy_ch0_gtrxreset_out [get_bd_pins ten_gig_eth_pcs_pma_ch0/gtrxreset_out] [get_bd_pins ten_gig_eth_pcs_pma_ch1/gtrxreset]
  connect_bd_net -net mac_phy_ch0_gttxreset_out [get_bd_pins ten_gig_eth_pcs_pma_ch0/gttxreset_out] [get_bd_pins ten_gig_eth_pcs_pma_ch1/gttxreset]
  connect_bd_net -net mac_phy_ch0_qpll0lock_out [get_bd_pins ten_gig_eth_pcs_pma_ch0/qpll0lock_out] [get_bd_pins ten_gig_eth_pcs_pma_ch1/qpll0lock]
  connect_bd_net -net mac_phy_ch0_qpll0outclk_out [get_bd_pins ten_gig_eth_pcs_pma_ch0/qpll0outclk_out] [get_bd_pins ten_gig_eth_pcs_pma_ch1/qpll0outclk]
  connect_bd_net -net mac_phy_ch0_qpll0outrefclk_out [get_bd_pins ten_gig_eth_pcs_pma_ch0/qpll0outrefclk_out] [get_bd_pins ten_gig_eth_pcs_pma_ch1/qpll0outrefclk]
  connect_bd_net -net mac_phy_ch0_reset_counter_done_out [get_bd_pins ten_gig_eth_pcs_pma_ch0/reset_counter_done_out] [get_bd_pins ten_gig_eth_pcs_pma_ch1/reset_counter_done]
  connect_bd_net -net mac_phy_ch0_txuserrdy_out [get_bd_pins ten_gig_eth_pcs_pma_ch0/txuserrdy_out] [get_bd_pins ten_gig_eth_pcs_pma_ch1/txuserrdy]
  connect_bd_net -net mac_phy_ch0_txusrclk2_out [get_bd_pins ten_gig_eth_pcs_pma_ch0/txusrclk2_out] [get_bd_pins ten_gig_eth_pcs_pma_ch1/txusrclk2]
  connect_bd_net -net mac_phy_ch0_txusrclk_out [get_bd_pins ten_gig_eth_pcs_pma_ch0/txusrclk_out] [get_bd_pins ten_gig_eth_pcs_pma_ch1/txusrclk]
  connect_bd_net -net mdc1_1 [get_bd_pins mdc_ch1] [get_bd_pins ten_gig_eth_pcs_pma_ch0/mdc]
  connect_bd_net -net mdc_1 [get_bd_pins mdc_ch0] [get_bd_pins ten_gig_eth_pcs_pma_ch1/mdc]
  connect_bd_net -net mdio_in1_1 [get_bd_pins mdio_in_ch1] [get_bd_pins ten_gig_eth_pcs_pma_ch0/mdio_in]
  connect_bd_net -net mdio_in_1 [get_bd_pins mdio_in_ch0] [get_bd_pins ten_gig_eth_pcs_pma_ch1/mdio_in]
  connect_bd_net -net pcs_subsystem_core_status [get_bd_pins core_status_ch0] [get_bd_pins ten_gig_eth_pcs_pma_ch1/core_status]
  connect_bd_net -net pcs_subsystem_core_status1 [get_bd_pins core_status_ch1] [get_bd_pins ten_gig_eth_pcs_pma_ch0/core_status]
  connect_bd_net -net pcs_subsystem_coreclk_out [get_bd_pins coreclk_out] [get_bd_pins ten_gig_eth_pcs_pma_ch0/coreclk_out] [get_bd_pins ten_gig_eth_pcs_pma_ch0/dclk] [get_bd_pins ten_gig_eth_pcs_pma_ch1/coreclk] [get_bd_pins ten_gig_eth_pcs_pma_ch1/dclk]
  connect_bd_net -net pcs_subsystem_mdio_out [get_bd_pins mdio_out_ch0] [get_bd_pins ten_gig_eth_pcs_pma_ch1/mdio_out]
  connect_bd_net -net pcs_subsystem_mdio_out1 [get_bd_pins mdio_out_ch1] [get_bd_pins ten_gig_eth_pcs_pma_ch0/mdio_out]
  connect_bd_net -net reset_n_mac_1 [get_bd_pins sys_reset_n] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net rxn_1 [get_bd_pins rxn_ch0] [get_bd_pins ten_gig_eth_pcs_pma_ch0/rxn]
  connect_bd_net -net rxn_2 [get_bd_pins rxn_ch1] [get_bd_pins ten_gig_eth_pcs_pma_ch1/rxn]
  connect_bd_net -net rxp_1 [get_bd_pins rxp_ch0] [get_bd_pins ten_gig_eth_pcs_pma_ch0/rxp]
  connect_bd_net -net rxp_2 [get_bd_pins rxp_ch1] [get_bd_pins ten_gig_eth_pcs_pma_ch1/rxp]
  connect_bd_net -net s_axis_pause_tvalid_1 [get_bd_pins ten_gig_eth_pcs_pma_ch0/tx_fault] [get_bd_pins ten_gig_eth_pcs_pma_ch1/tx_fault] [get_bd_pins xlconstant_1b0/dout]
  ...
  connect_bd_net -net ten_gig_eth_pcs_pma_ch0_tx_disable [get_bd_pins tx_disable_ch0] [get_bd_pins ten_gig_eth_pcs_pma_ch0/tx_disable]
  connect_bd_net -net ten_gig_eth_pcs_pma_ch0_txn [get_bd_pins txn_ch0] [get_bd_pins ten_gig_eth_pcs_pma_ch0/txn]
  connect_bd_net -net ten_gig_eth_pcs_pma_ch0_txp [get_bd_pins txp_ch0] [get_bd_pins ten_gig_eth_pcs_pma_ch0/txp]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins ten_gig_eth_pcs_pma_ch0/reset] [get_bd_pins ten_gig_eth_pcs_pma_ch1/areset] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net xlconstant_0_const [get_bd_pins ten_gig_eth_pcs_pma_ch0/signal_detect] [get_bd_pins ten_gig_eth_pcs_pma_ch0/sim_speedup_control] [get_bd_pins ten_gig_eth_pcs_pma_ch1/signal_detect] [get_bd_pins ten_gig_eth_pcs_pma_ch1/sim_speedup_control] [get_bd_pins xlconstant_1b1/dout]
  connect_bd_net -net xlconstant_3b101_dout [get_bd_pins ten_gig_eth_pcs_pma_ch0/pma_pmd_type] [get_bd_pins ten_gig_eth_pcs_pma_ch1/pma_pmd_type] [get_bd_pins xlconstant_3b101/dout]
...
proc create_hier_cell_PORT01 { parentCell nameHier } {
  ...
  connect_bd_net -net axi_aclk_port_data_1 [get_bd_pins axi_aclk_port_data] [get_bd_pins port01_mux_in/axi_aclk_port_data] [get_bd_pins port01_mux_out/axi_aclk_role_data]
  connect_bd_net -net axi_aresetn_port_data_1 [get_bd_pins axi_aresetn_port_data] [get_bd_pins port01_mux_in/axi_aresetn_port_data] [get_bd_pins port01_mux_out/axi_aresetn_role_data]
  connect_bd_net -net shell_core_axi_aclk [get_bd_pins axi_aclk_port_ctrl] [get_bd_pins port01_mux_in/axi_aclk_port_ctrl] [get_bd_pins port01_mux_out/axi_aclk_role_ctrl]
  connect_bd_net -net shell_core_axi_aresetn [get_bd_pins axi_aresetn_port_ctrl] [get_bd_pins port01_mux_in/axi_aresetn_port_ctrl] [get_bd_pins port01_mux_out/axi_aresetn_role_ctrl]
...
proc create_hier_cell_FME { parentCell nameHier } {
  ...
  create_bd_pin -dir O axi_aclk_role_ctrl
  create_bd_pin -dir I -type clk axi_aclk_role_data
  create_bd_pin -dir O -from 0 -to 0 axi_aresetn_role_ctrl
  create_bd_pin -dir I -type rst axi_aresetn_role_data
  create_bd_pin -dir O -type clk clk_mdc
  ...
  # Create port connections
  connect_bd_net -net ARESETN_1 [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/M04_ARESETN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/M01_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins proc_sys_reset_0/interconnect_aresetn]
  connect_bd_net -net axi_aclk_role_data_1 [get_bd_pins axi_aclk_role_data] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins debug_bridge_s0/clk]
  connect_bd_net -net axi_aresetn_role_ctrl_1 [get_bd_pins axi_aresetn_role_ctrl] [get_bd_pins axi_hwicap/s_axi_aresetn] [get_bd_pins flash_programmer/s_axi_aresetn] [get_bd_pins pf_csr/axi_aresetn_role_ctrl] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins system_management_wiz_0/s_axi_aresetn]
  connect_bd_net -net axi_aresetn_role_data_1 [get_bd_pins axi_aresetn_role_data] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins clk_wiz_0/resetn]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axi_aclk_role_ctrl] [get_bd_pins axi_hwicap/icap_clk] [get_bd_pins axi_hwicap/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/M01_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins flash_programmer/ext_spi_clk] [get_bd_pins flash_programmer/s_axi_aclk] [get_bd_pins pf_csr/axi_aclk_role_ctrl] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins system_management_wiz_0/s_axi_aclk]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins clk_mdc] [get_bd_pins clk_wiz_0/clk_out2]
...
proc create_hier_cell_FIU { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 eth_refclk
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:pcie_7x_mgt_rtl:1.0 pci_express
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 pcie_refclk
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:xgmii_rtl:1.0 xgmii_interface_ch0
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:xgmii_rtl:1.0 xgmii_interface_ch1
  ...
  # Create instance: eth_phy
  create_hier_cell_eth_phy $hier_obj eth_phy
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins xgmii_interface_ch0] [get_bd_intf_pins eth_phy/xgmii_interface_ch0]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins xgmii_interface_ch1] [get_bd_intf_pins eth_phy/xgmii_interface_ch1]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins eth_refclk] [get_bd_intf_pins eth_phy/refclk_diff]
  ...
  # Create port connections
  connect_bd_net -net eth_phy_tx_disable_ch0 [get_bd_pins tx_disable_ch0] [get_bd_pins eth_phy/tx_disable_ch0]
  connect_bd_net -net eth_phy_tx_disable_ch1 [get_bd_pins tx_disable_ch1] [get_bd_pins eth_phy/tx_disable_ch1]
  connect_bd_net -net eth_phy_txn_ch0 [get_bd_pins txn_ch0] [get_bd_pins eth_phy/txn_ch0]
  connect_bd_net -net eth_phy_txn_ch1 [get_bd_pins txn_ch1] [get_bd_pins eth_phy/txn_ch1]
  connect_bd_net -net eth_phy_txp_ch0 [get_bd_pins txp_ch0] [get_bd_pins eth_phy/txp_ch0]
  connect_bd_net -net eth_phy_txp_ch1 [get_bd_pins txp_ch1] [get_bd_pins eth_phy/txp_ch1]
  connect_bd_net -net ether_test_subsys_core_status1_0 [get_bd_pins core_status_ch1] [get_bd_pins eth_phy/core_status_ch1]
  connect_bd_net -net ether_test_subsys_core_status_0 [get_bd_pins core_status_ch0] [get_bd_pins eth_phy/core_status_ch0]
  connect_bd_net -net ether_test_subsys_coreclk_out_0 [get_bd_pins coreclk_out] [get_bd_pins eth_phy/coreclk_out]
  connect_bd_net -net ether_test_subsys_mdio_out1_0 [get_bd_pins mdio_out_ch1] [get_bd_pins eth_phy/mdio_out_ch1]
  connect_bd_net -net ether_test_subsys_mdio_out_0 [get_bd_pins mdio_out_ch0] [get_bd_pins eth_phy/mdio_out_ch0]
  connect_bd_net -net mdc1_0_1 [get_bd_pins mdc_ch1] [get_bd_pins eth_phy/mdc_ch1]
  connect_bd_net -net mdc_0_1 [get_bd_pins mdc_ch0] [get_bd_pins eth_phy/mdc_ch0]
  connect_bd_net -net mdio_in1_0_1 [get_bd_pins mdio_in_ch1] [get_bd_pins eth_phy/mdio_in_ch1]
  connect_bd_net -net mdio_in_0_1 [get_bd_pins mdio_in_ch0] [get_bd_pins eth_phy/mdio_in_ch0]
...
proc create_hier_cell_FIM { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:xgmii_rtl:1.0 eth_afu_xgmii_ch0
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:xgmii_rtl:1.0 eth_afu_xgmii_ch1
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 eth_refclk
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:pcie_7x_mgt_rtl:1.0 pci_express
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 pcie_refclk
  ...
  create_bd_pin -dir O -from 7 -to 0 eth_afu_core_status_ch0
  create_bd_pin -dir O -from 7 -to 0 eth_afu_core_status_ch1
  create_bd_pin -dir O -type clk eth_afu_coreclk_out
  create_bd_pin -dir O eth_afu_mdc_out
  create_bd_pin -dir I eth_afu_mdio_in_ch0
  create_bd_pin -dir I eth_afu_mdio_in_ch1
  create_bd_pin -dir O eth_afu_mdio_out_ch0
  create_bd_pin -dir O eth_afu_mdio_out_ch1
  create_bd_pin -dir I eth_rxn_ch0
  create_bd_pin -dir I eth_rxn_ch1
  create_bd_pin -dir I eth_rxp_ch0
  create_bd_pin -dir I eth_rxp_ch1
  create_bd_pin -dir O eth_tx_disable_ch0
  create_bd_pin -dir O eth_tx_disable_ch1
  create_bd_pin -dir O eth_txn_ch0
  create_bd_pin -dir O eth_txn_ch1
  create_bd_pin -dir O eth_txp_ch0
  create_bd_pin -dir O eth_txp_ch1
  create_bd_pin -dir I -type rst pcie_perstn
  ...
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins eth_afu_xgmii_ch0] [get_bd_intf_pins FIU/xgmii_interface_ch0]
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins eth_afu_xgmii_ch1] [get_bd_intf_pins FIU/xgmii_interface_ch1]
  connect_bd_intf_net -intf_net Conn5 [get_bd_intf_pins eth_refclk] [get_bd_intf_pins FIU/eth_refclk]
  ...
  # Create port connections
  connect_bd_net -net FIU_axi_aclk_port_data [get_bd_pins axi_aclk_data_port] [get_bd_pins FIU/axi_aclk_port_data] [get_bd_pins FME/axi_aclk_role_data] [get_bd_pins PORT01/axi_aclk_port_data]
  connect_bd_net -net FIU_axi_aresetn_port_data [get_bd_pins axi_aresetn_data_port] [get_bd_pins FIU/axi_aresetn_port_data] [get_bd_pins FME/axi_aresetn_role_data] [get_bd_pins PORT01/axi_aresetn_port_data]
  connect_bd_net -net FIU_core_status1_0 [get_bd_pins eth_afu_core_status_ch1] [get_bd_pins FIU/core_status_ch1]
  connect_bd_net -net FIU_core_status_0 [get_bd_pins eth_afu_core_status_ch0] [get_bd_pins FIU/core_status_ch0]
  connect_bd_net -net FIU_coreclk_out_0 [get_bd_pins eth_afu_coreclk_out] [get_bd_pins FIU/coreclk_out]
  connect_bd_net -net FIU_mdio_out1_0 [get_bd_pins eth_afu_mdio_out_ch1] [get_bd_pins FIU/mdio_out_ch1]
  connect_bd_net -net FIU_mdio_out_0 [get_bd_pins eth_afu_mdio_out_ch0] [get_bd_pins FIU/mdio_out_ch0]
  connect_bd_net -net FIU_tx_disable_ch0_0 [get_bd_pins eth_tx_disable_ch0] [get_bd_pins FIU/tx_disable_ch0]
  connect_bd_net -net FIU_tx_disable_ch1_0 [get_bd_pins eth_tx_disable_ch1] [get_bd_pins FIU/tx_disable_ch1]
  connect_bd_net -net FIU_txn_ch0_0 [get_bd_pins eth_txn_ch0] [get_bd_pins FIU/txn_ch0]
  connect_bd_net -net FIU_txn_ch1_0 [get_bd_pins eth_txn_ch1] [get_bd_pins FIU/txn_ch1]
  connect_bd_net -net FIU_txp_ch0_0 [get_bd_pins eth_txp_ch0] [get_bd_pins FIU/txp_ch0]
  connect_bd_net -net FIU_txp_ch1_0 [get_bd_pins eth_txp_ch1] [get_bd_pins FIU/txp_ch1]
  ...
  connect_bd_net -net axi_aclk_port_ctrl_1 [get_bd_pins axi_aclk_ctrl_port] [get_bd_pins FME/axi_aclk_role_ctrl] [get_bd_pins PORT01/axi_aclk_port_ctrl]
  connect_bd_net -net axi_aresetn_port_ctrl_1 [get_bd_pins axi_aresetn_ctrl_port] [get_bd_pins FME/axi_aresetn_role_ctrl] [get_bd_pins PORT01/axi_aresetn_port_ctrl]
  connect_bd_net -net mdc_ch0_1 [get_bd_pins eth_afu_mdc_out] [get_bd_pins FIU/mdc_ch0] [get_bd_pins FIU/mdc_ch1] [get_bd_pins FME/clk_mdc]
  connect_bd_net -net mdio_in1_0_1 [get_bd_pins eth_afu_mdio_in_ch1] [get_bd_pins FIU/mdio_in_ch1]
  connect_bd_net -net mdio_in_0_1 [get_bd_pins eth_afu_mdio_in_ch0] [get_bd_pins FIU/mdio_in_ch0]
  connect_bd_net -net rxn_ch0_0_1 [get_bd_pins eth_rxn_ch0] [get_bd_pins FIU/rxn_ch0]
  connect_bd_net -net rxn_ch1_0_1 [get_bd_pins eth_rxn_ch1] [get_bd_pins FIU/rxn_ch1]
  connect_bd_net -net rxp_ch0_0_1 [get_bd_pins eth_rxp_ch0] [get_bd_pins FIU/rxp_ch0]
  connect_bd_net -net rxp_ch1_0_1 [get_bd_pins eth_rxp_ch1] [get_bd_pins FIU/rxp_ch1]
...
proc create_root_design { parentCell } {
  ...
  set eth_refclk [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 eth_refclk ]
  set_property -dict [ list \
  ...
  # Create ports
  set eth_rxn_ch0 [ create_bd_port -dir I eth_rxn_ch0 ]
  set eth_rxn_ch1 [ create_bd_port -dir I eth_rxn_ch1 ]
  set eth_rxp_ch0 [ create_bd_port -dir I eth_rxp_ch0 ]
  set eth_rxp_ch1 [ create_bd_port -dir I eth_rxp_ch1 ]
  set eth_tx_disable_ch0 [ create_bd_port -dir O eth_tx_disable_ch0 ]
  set eth_tx_disable_ch1 [ create_bd_port -dir O eth_tx_disable_ch1 ]
  set eth_txn_ch0 [ create_bd_port -dir O eth_txn_ch0 ]
  set eth_txn_ch1 [ create_bd_port -dir O eth_txn_ch1 ]
  set eth_txp_ch0 [ create_bd_port -dir O eth_txp_ch0 ]
  set eth_txp_ch1 [ create_bd_port -dir O eth_txp_ch1 ]
  ...
  connect_bd_intf_net -intf_net refclk_diff_0_1 [get_bd_intf_ports eth_refclk] [get_bd_intf_pins FIM/eth_refclk]

  # Create port connections
  connect_bd_net -net FIM_tx_disable_ch0_0 [get_bd_ports eth_tx_disable_ch0] [get_bd_pins FIM/eth_tx_disable_ch0]
  connect_bd_net -net FIM_tx_disable_ch1_0 [get_bd_ports eth_tx_disable_ch1] [get_bd_pins FIM/eth_tx_disable_ch1]
  connect_bd_net -net FIM_txn_ch0_0 [get_bd_ports eth_txn_ch0] [get_bd_pins FIM/eth_txn_ch0]
  connect_bd_net -net FIM_txn_ch1_0 [get_bd_ports eth_txn_ch1] [get_bd_pins FIM/eth_txn_ch1]
  connect_bd_net -net FIM_txp_ch0_0 [get_bd_ports eth_txp_ch0] [get_bd_pins FIM/eth_txp_ch0]
  connect_bd_net -net FIM_txp_ch1_0 [get_bd_ports eth_txp_ch1] [get_bd_pins FIM/eth_txp_ch1]
  connect_bd_net -net rxn_ch0_0_0_1 [get_bd_ports eth_rxn_ch0] [get_bd_pins FIM/eth_rxn_ch0]
  connect_bd_net -net rxn_ch1_0_0_1 [get_bd_ports eth_rxn_ch1] [get_bd_pins FIM/eth_rxn_ch1]
  connect_bd_net -net rxp_ch0_0_0_1 [get_bd_ports eth_rxp_ch0] [get_bd_pins FIM/eth_rxp_ch0]
  connect_bd_net -net rxp_ch1_0_0_1 [get_bd_ports eth_rxp_ch1] [get_bd_pins FIM/eth_rxp_ch1]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x00018000 [get_bd_addr_spaces FIM/FIU/jtag_axi_0/Data] [get_bd_addr_segs FIM/PORT01/port01_mux_out/pr_axi_shutdown_mana_0/S_AXI_CTRL/Reg] SEG_pr_axi_shutdown_mana_0_Reg1
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x0001A000 [get_bd_addr_spaces FIM/FIU/jtag_axi_0/Data] [get_bd_addr_segs FIM/PORT01/port01_mux_out/pr_axi_shutdown_mana_1/S_AXI_CTRL/Reg] SEG_pr_axi_shutdown_mana_1_Reg1
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x00000000 [get_bd_addr_spaces FIM/FIU/pcie_axi_bridge/axi_pcie3_0/M_AXI] [get_bd_addr_segs FIM/FIU/feature_ram/axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
  create_bd_addr_seg -range 0x00001000 -offset 0x00014000 [get_bd_addr_spaces FIM/FIU/pcie_axi_bridge/axi_pcie3_0/M_AXI] [get_bd_addr_segs FIM/PORT01/port01_mux_out/axi_firewall_0/S_AXI_CTL/Control] SEG_axi_firewall_0_Control
  create_bd_addr_seg -range 0x00001000 -offset 0x00015000 [get_bd_addr_spaces FIM/FIU/pcie_axi_bridge/axi_pcie3_0/M_AXI] [get_bd_addr_segs FIM/PORT01/port01_mux_out/axi_firewall_1/S_AXI_CTL/Control] SEG_axi_firewall_1_Control
  create_bd_addr_seg -range 0x00001000 -offset 0x00012000 [get_bd_addr_spaces FIM/FIU/pcie_axi_bridge/axi_pcie3_0/M_AXI] [get_bd_addr_segs FIM/FME/axi_hwicap/S_AXI_LITE/Reg] SEG_axi_hwicap_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x00013000 [get_bd_addr_spaces FIM/FIU/pcie_axi_bridge/axi_pcie3_0/M_AXI] [get_bd_addr_segs FIM/FME/flash_programmer/AXI_LITE/Reg] SEG_flash_programmer_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x00011000 [get_bd_addr_spaces FIM/FIU/pcie_axi_bridge/axi_pcie3_0/M_AXI] [get_bd_addr_segs FIM/FME/pf_csr/pf_csr_v1_0_0/s00_axi/reg0] SEG_pf_csr_v1_0_0_reg0
  create_bd_addr_seg -range 0x00001000 -offset 0x00019000 [get_bd_addr_spaces FIM/FIU/pcie_axi_bridge/axi_pcie3_0/M_AXI] [get_bd_addr_segs FIM/PORT01/port01_mux_in/pr_axi_shutdown_mana_0/S_AXI_CTRL/Reg] SEG_pr_axi_shutdown_mana_0_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x00018000 [get_bd_addr_spaces FIM/FIU/pcie_axi_bridge/axi_pcie3_0/M_AXI] [get_bd_addr_segs FIM/PORT01/port01_mux_out/pr_axi_shutdown_mana_0/S_AXI_CTRL/Reg] SEG_pr_axi_shutdown_mana_0_Reg1
  create_bd_addr_seg -range 0x00001000 -offset 0x0001B000 [get_bd_addr_spaces FIM/FIU/pcie_axi_bridge/axi_pcie3_0/M_AXI] [get_bd_addr_segs FIM/PORT01/port01_mux_in/pr_axi_shutdown_mana_1/S_AXI_CTRL/Reg] SEG_pr_axi_shutdown_mana_1_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x0001A000 [get_bd_addr_spaces FIM/FIU/pcie_axi_bridge/axi_pcie3_0/M_AXI] [get_bd_addr_segs FIM/PORT01/port01_mux_out/pr_axi_shutdown_mana_1/S_AXI_CTRL/Reg] SEG_pr_axi_shutdown_mana_1_Reg1
  create_bd_addr_seg -range 0x00001000 -offset 0x0001E000 [get_bd_addr_spaces FIM/FIU/pcie_axi_bridge/axi_pcie3_0/M_AXI] [get_bd_addr_segs FIM/FME/system_management_wiz_0/S_AXI_LITE/Reg] SEG_system_management_wiz_0_Reg
