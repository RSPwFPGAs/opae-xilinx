...
xilinx.com:ip:pcie3_ultrascale:*\
xilinx.com:ip:pcie_2_axilite:*\
...
proc create_hier_cell_port01_mux_out { parentCell nameHier } {
  ...
  # Create pins
  create_bd_pin -dir O -from 0 -to 0 O_PORT0_RSTN
  create_bd_pin -dir O -from 0 -to 0 O_PORT1_RSTN
  create_bd_pin -dir I -type clk axi_aclk_role_ctrl
  ...
  connect_bd_intf_net -intf_net axi_interconnect_2_M04_AXI [get_bd_intf_pins axi_interconnect_0/M04_AXI] [get_bd_intf_pins pf_csr/s00_axi]
  ...
  # Create port connections
  connect_bd_net -net M00_ARESETN_1 [get_bd_pins axi_aresetn_role_ctrl] [get_bd_pins axi_firewall_0/aresetn] [get_bd_pins axi_firewall_1/aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/M04_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_2/ARESETN] [get_bd_pins axi_interconnect_2/M00_ARESETN] [get_bd_pins axi_interconnect_3/ARESETN] [get_bd_pins axi_interconnect_3/M00_ARESETN] [get_bd_pins pf_csr/axi_aresetn_role_ctrl] [get_bd_pins pr_axi_shutdown_mana_0/resetn] [get_bd_pins pr_axi_shutdown_mana_1/resetn]
  connect_bd_net -net axi_aclk_role_ctrl_1 [get_bd_pins axi_aclk_role_ctrl] [get_bd_pins axi_firewall_0/aclk] [get_bd_pins axi_firewall_1/aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_2/ACLK] [get_bd_pins axi_interconnect_2/M00_ACLK] [get_bd_pins axi_interconnect_3/ACLK] [get_bd_pins axi_interconnect_3/M00_ACLK] [get_bd_pins pf_csr/axi_aclk_role_ctrl] [get_bd_pins pr_axi_shutdown_mana_0/clk] [get_bd_pins pr_axi_shutdown_mana_1/clk]
  ...
  connect_bd_net -net pf_csr_O_ROLE_RSTN_0 [get_bd_pins O_PORT0_RSTN] [get_bd_pins pf_csr/O_ROLE_RSTN_0]
  connect_bd_net -net pf_csr_O_ROLE_RSTN_1 [get_bd_pins O_PORT1_RSTN] [get_bd_pins pf_csr/O_ROLE_RSTN_1]
...
proc create_hier_cell_port01_mux_in { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:display_qdma:usr_irq_rtl:1.0 S_USR_IRQ_ROLE0
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:display_qdma:usr_irq_rtl:1.0 S_USR_IRQ_ROLE1
...
proc create_hier_cell_PORT01 { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net S_USR_IRQ_ROLE0_1 [get_bd_intf_pins S_USR_IRQ_ROLE0] [get_bd_intf_pins port01_mux_in/S_USR_IRQ_ROLE0]
  connect_bd_intf_net -intf_net S_USR_IRQ_ROLE1_1 [get_bd_intf_pins S_USR_IRQ_ROLE1] [get_bd_intf_pins port01_mux_in/S_USR_IRQ_ROLE1]
  ...
  connect_bd_net -net shell_mux_out_O_ROLE_RSTN_0_0 [get_bd_pins O_PORT0_RSTN] [get_bd_pins port01_mux_out/O_PORT0_RSTN]
  connect_bd_net -net shell_mux_out_O_ROLE_RSTN_1_0 [get_bd_pins O_PORT1_RSTN] [get_bd_pins port01_mux_out/O_PORT1_RSTN]
...
proc create_hier_cell_FME { parentCell nameHier } {
  ...
  connect_bd_net -net qdma_0_axi_aclk [get_bd_pins axi_aclk_role_data] [get_bd_pins axi_hwicap/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/M01_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins debug_bridge_s0/clk] [get_bd_pins flash_programmer/s_axi_aclk] [get_bd_pins system_management_wiz_0/s_axi_aclk]
  connect_bd_net -net qdma_0_axi_aresetn [get_bd_pins axi_aresetn_role_data] [get_bd_pins axi_hwicap/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/M01_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins flash_programmer/s_axi_aresetn] [get_bd_pins system_management_wiz_0/s_axi_aresetn]
...
proc create_hier_cell_FIU { parentCell nameHier } {
  ...
  set pcie3_ultrascale_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:pcie3_ultrascale pcie3_ultrascale_0 ]
  set_property -dict [ list \
   ...
   CONFIG.xlnx_ref_board {KCU105} \
 ] $pcie3_ultrascale_0

  # Create instance: pcie_2_axilite_0, and set properties
  set pcie_2_axilite_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:pcie_2_axilite pcie_2_axilite_0 ]
  set_property -dict [ list \
   CONFIG.BAR0SIZE {0xFFFFFFFFFFF80000} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins M_AXI_LITE_PORT0_CTRL] [get_bd_intf_pins pf_demux_0/M_AXI_LITE_ROLE0PF]
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins M_AXI_LITE_PORT1_CTRL] [get_bd_intf_pins pf_demux_0/M_AXI_LITE_ROLE1PF]
  connect_bd_intf_net -intf_net S_AXI_BRIDGE_1 [get_bd_intf_pins S_AXI_BRIDGE] [get_bd_intf_pins axi_bram_ctrl_0/S_AXI]
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTA [get_bd_intf_pins axi_bram_ctrl_0/BRAM_PORTA] [get_bd_intf_pins blk_mem_gen_0/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTB [get_bd_intf_pins axi_bram_ctrl_0/BRAM_PORTB] [get_bd_intf_pins blk_mem_gen_0/BRAM_PORTB]
  ...
  connect_bd_intf_net -intf_net pcie3_ultrascale_0_m_axis_cq [get_bd_intf_pins pcie3_ultrascale_0/m_axis_cq] [get_bd_intf_pins pcie_2_axilite_0/s_axis_cq]
  connect_bd_intf_net -intf_net [get_bd_intf_nets pcie3_ultrascale_0_m_axis_cq] [get_bd_intf_pins ila_0/SLOT_0_AXIS] [get_bd_intf_pins pcie3_ultrascale_0/m_axis_cq]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets pcie3_ultrascale_0_m_axis_cq]
  connect_bd_intf_net -intf_net pcie3_ultrascale_0_pcie_7x_mgt [get_bd_intf_pins pci_express] [get_bd_intf_pins pcie3_ultrascale_0/pcie_7x_mgt]
  ...
  connect_bd_intf_net -intf_net pcie_2_axilite_0_m_axi_1 [get_bd_intf_pins axi_interconnect_0/S00_AXI] [get_bd_intf_pins pcie_2_axilite_0/m_axi]
  connect_bd_intf_net -intf_net [get_bd_intf_nets pcie_2_axilite_0_m_axi_1] [get_bd_intf_pins axi_interconnect_0/S00_AXI] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  connect_bd_intf_net -intf_net pcie_2_axilite_0_m_axis_cc [get_bd_intf_pins pcie3_ultrascale_0/s_axis_cc] [get_bd_intf_pins pcie_2_axilite_0/m_axis_cc]
  connect_bd_intf_net -intf_net [get_bd_intf_nets pcie_2_axilite_0_m_axis_cc] [get_bd_intf_pins ila_1/SLOT_0_AXIS] [get_bd_intf_pins pcie_2_axilite_0/m_axis_cc]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets pcie_2_axilite_0_m_axis_cc]
  connect_bd_intf_net -intf_net pcie_refclk_1 [get_bd_intf_pins pcie_refclk] [get_bd_intf_pins util_ds_buf/CLK_IN_D]

  # Create port connections
  connect_bd_net -net pcie3_ultrascale_0_user_reset [get_bd_pins pcie3_ultrascale_0/user_reset] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net qdma_0_axi_aclk [get_bd_pins axi_aclk_port_data] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins feature_ram/axi_aclk_role_ctrl] [get_bd_pins ila_0/clk] [get_bd_pins ila_1/clk] [get_bd_pins jtag_axi_0/aclk] [get_bd_pins pcie3_ultrascale_0/user_clk] [get_bd_pins pcie_2_axilite_0/axi_clk] [get_bd_pins pf_demux_0/M_AXI_LITE_ROLE0PF_clk] [get_bd_pins pf_demux_0/M_AXI_LITE_ROLE1PF_clk] [get_bd_pins pf_demux_0/M_AXI_LITE_SHELLPF_clk] [get_bd_pins pf_demux_0/S_AXI_LITE_clk] [get_bd_pins system_ila_0/clk]
  connect_bd_net -net qdma_0_axi_aresetn [get_bd_pins axi_aresetn_port_data] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins feature_ram/axi_aresetn_role_ctrl] [get_bd_pins jtag_axi_0/aresetn] [get_bd_pins pcie_2_axilite_0/axi_aresetn] [get_bd_pins pf_demux_0/M_AXI_LITE_ROLE0PF_aresetn] [get_bd_pins pf_demux_0/M_AXI_LITE_ROLE1PF_aresetn] [get_bd_pins pf_demux_0/M_AXI_LITE_SHELLPF_aresetn] [get_bd_pins pf_demux_0/S_AXI_LITE_aresetn] [get_bd_pins system_ila_0/resetn] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net sys_reset_0_1 [get_bd_pins pcie_perstn] [get_bd_pins pcie3_ultrascale_0/sys_reset]
  connect_bd_net -net util_ds_buf_IBUF_DS_ODIV2 [get_bd_pins pcie3_ultrascale_0/sys_clk] [get_bd_pins util_ds_buf/IBUF_DS_ODIV2]
  connect_bd_net -net util_ds_buf_IBUF_OUT [get_bd_pins pcie3_ultrascale_0/sys_clk_gt] [get_bd_pins util_ds_buf/IBUF_OUT]
...
proc create_hier_cell_FIM { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 S_AXI_FULL_PORT0_DATA
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 S_AXI_FULL_PORT1_DATA
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:display_qdma:usr_irq_rtl:1.0 S_USR_IRQ_PORT0
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:display_qdma:usr_irq_rtl:1.0 S_USR_IRQ_PORT1
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:pcie_7x_mgt_rtl:1.0 pci_express
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 pcie_refclk
  ...
  create_bd_pin -dir O -from 0 -to 0 O_PORT0_RSTN
  create_bd_pin -dir O -from 0 -to 0 O_PORT1_RSTN
  create_bd_pin -dir O -type clk axi_aclk_port_ctrl
  create_bd_pin -dir O -type clk axi_aclk_port_data
  create_bd_pin -dir O -from 0 -to 0 -type rst axi_aresetn_port_ctrl
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins S_AXI_FULL_PORT0_DATA] [get_bd_intf_pins PORT01/S_AXI_FULL_PORT0_DATA]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins S_AXI_FULL_PORT1_DATA] [get_bd_intf_pins PORT01/S_AXI_FULL_PORT1_DATA]
  ...
  connect_bd_intf_net -intf_net S_USR_IRQ_ROLE0_1 [get_bd_intf_pins S_USR_IRQ_PORT0] [get_bd_intf_pins PORT01/S_USR_IRQ_ROLE0]
  connect_bd_intf_net -intf_net S_USR_IRQ_ROLE1_1 [get_bd_intf_pins S_USR_IRQ_PORT1] [get_bd_intf_pins PORT01/S_USR_IRQ_ROLE1]
  ...
  connect_bd_intf_net -intf_net shell_mux_out_M_AXI_LITE_ROLE0_CTRL [get_bd_intf_pins M_AXI_LITE_PORT0_CTRL] [get_bd_intf_pins PORT01/M_AXI_LITE_PORT0_CTRL]
  connect_bd_intf_net -intf_net shell_mux_out_M_AXI_LITE_ROLE1_CTRL [get_bd_intf_pins M_AXI_LITE_PORT1_CTRL] [get_bd_intf_pins PORT01/M_AXI_LITE_PORT1_CTRL]

  # Create port connections
  connect_bd_net -net shell_core_axi_aclk [get_bd_pins axi_aclk_port_ctrl] [get_bd_pins axi_aclk_port_data] [get_bd_pins FIU/axi_aclk_port_data] [get_bd_pins FME/axi_aclk_role_data] [get_bd_pins PORT01/axi_aclk_port_ctrl]
  connect_bd_net -net shell_core_axi_aresetn [get_bd_pins axi_aresetn_port_ctrl] [get_bd_pins axi_aresetn_port_data] [get_bd_pins FIU/axi_aresetn_port_data] [get_bd_pins FME/axi_aresetn_role_data] [get_bd_pins PORT01/axi_aresetn_port_ctrl]
  connect_bd_net -net shell_mux_out_O_ROLE_RSTN_0_0 [get_bd_pins O_PORT0_RSTN] [get_bd_pins PORT01/O_PORT0_RSTN]
  connect_bd_net -net shell_mux_out_O_ROLE_RSTN_1_0 [get_bd_pins O_PORT1_RSTN] [get_bd_pins PORT01/O_PORT1_RSTN]
...
proc create_root_design { parentCell } {
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x00011000 [get_bd_addr_spaces FIM/FIU/jtag_axi_0/Data] [get_bd_addr_segs FIM/PORT01/port01_mux_out/pf_csr/pf_csr_v1_0_0/s00_axi/reg0] SEG_pf_csr_v1_0_0_reg0
  create_bd_addr_seg -range 0x00001000 -offset 0x00018000 [get_bd_addr_spaces FIM/FIU/jtag_axi_0/Data] [get_bd_addr_segs FIM/PORT01/port01_mux_out/pr_axi_shutdown_mana_0/S_AXI_CTRL/Reg] SEG_pr_axi_shutdown_mana_0_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x00019000 [get_bd_addr_spaces FIM/FIU/jtag_axi_0/Data] [get_bd_addr_segs FIM/PORT01/port01_mux_in/pr_axi_shutdown_mana_0/S_AXI_CTRL/Reg] SEG_pr_axi_shutdown_mana_0_Reg1
  create_bd_addr_seg -range 0x00001000 -offset 0x0001A000 [get_bd_addr_spaces FIM/FIU/jtag_axi_0/Data] [get_bd_addr_segs FIM/PORT01/port01_mux_out/pr_axi_shutdown_mana_1/S_AXI_CTRL/Reg] SEG_pr_axi_shutdown_mana_1_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x0001B000 [get_bd_addr_spaces FIM/FIU/jtag_axi_0/Data] [get_bd_addr_segs FIM/PORT01/port01_mux_in/pr_axi_shutdown_mana_1/S_AXI_CTRL/Reg] SEG_pr_axi_shutdown_mana_1_Reg1
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x00000000 [get_bd_addr_spaces FIM/FIU/pcie_2_axilite_0/m_axi] [get_bd_addr_segs FIM/FIU/feature_ram/axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
  create_bd_addr_seg -range 0x00001000 -offset 0x00014000 [get_bd_addr_spaces FIM/FIU/pcie_2_axilite_0/m_axi] [get_bd_addr_segs FIM/PORT01/port01_mux_out/axi_firewall_0/S_AXI_CTL/Control] SEG_axi_firewall_0_Control
  create_bd_addr_seg -range 0x00001000 -offset 0x00015000 [get_bd_addr_spaces FIM/FIU/pcie_2_axilite_0/m_axi] [get_bd_addr_segs FIM/PORT01/port01_mux_out/axi_firewall_1/S_AXI_CTL/Control] SEG_axi_firewall_1_Control
  create_bd_addr_seg -range 0x00001000 -offset 0x00012000 [get_bd_addr_spaces FIM/FIU/pcie_2_axilite_0/m_axi] [get_bd_addr_segs FIM/FME/axi_hwicap/S_AXI_LITE/Reg] SEG_axi_hwicap_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x00013000 [get_bd_addr_spaces FIM/FIU/pcie_2_axilite_0/m_axi] [get_bd_addr_segs FIM/FME/flash_programmer/AXI_LITE/Reg] SEG_flash_programmer_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x00011000 [get_bd_addr_spaces FIM/FIU/pcie_2_axilite_0/m_axi] [get_bd_addr_segs FIM/PORT01/port01_mux_out/pf_csr/pf_csr_v1_0_0/s00_axi/reg0] SEG_pf_csr_v1_0_0_reg0
  create_bd_addr_seg -range 0x00001000 -offset 0x00019000 [get_bd_addr_spaces FIM/FIU/pcie_2_axilite_0/m_axi] [get_bd_addr_segs FIM/PORT01/port01_mux_in/pr_axi_shutdown_mana_0/S_AXI_CTRL/Reg] SEG_pr_axi_shutdown_mana_0_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x00018000 [get_bd_addr_spaces FIM/FIU/pcie_2_axilite_0/m_axi] [get_bd_addr_segs FIM/PORT01/port01_mux_out/pr_axi_shutdown_mana_0/S_AXI_CTRL/Reg] SEG_pr_axi_shutdown_mana_0_Reg1
  create_bd_addr_seg -range 0x00001000 -offset 0x0001A000 [get_bd_addr_spaces FIM/FIU/pcie_2_axilite_0/m_axi] [get_bd_addr_segs FIM/PORT01/port01_mux_out/pr_axi_shutdown_mana_1/S_AXI_CTRL/Reg] SEG_pr_axi_shutdown_mana_1_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x0001B000 [get_bd_addr_spaces FIM/FIU/pcie_2_axilite_0/m_axi] [get_bd_addr_segs FIM/PORT01/port01_mux_in/pr_axi_shutdown_mana_1/S_AXI_CTRL/Reg] SEG_pr_axi_shutdown_mana_1_Reg1
  create_bd_addr_seg -range 0x00001000 -offset 0x0001E000 [get_bd_addr_spaces FIM/FIU/pcie_2_axilite_0/m_axi] [get_bd_addr_segs FIM/FME/system_management_wiz_0/S_AXI_LITE/Reg] SEG_system_management_wiz_0_Reg
